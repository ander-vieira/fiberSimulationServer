...
@JsonComponent
public class CSVInterpolatorParamsDTODeserializer extends JsonDeserializer<CSVInterpolatorParamsDTO> {
    @Override
    public CSVInterpolatorParamsDTO deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        return CSVInterpolatorParamsDTO.builder()
