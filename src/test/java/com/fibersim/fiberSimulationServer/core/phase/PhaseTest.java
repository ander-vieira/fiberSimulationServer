...
public class PhaseTest {
    @Test
    @Tag("UnitTest")
    public void planePhaseTest() {
        Phase planePhase = new PlanePhase(Vector3.Z, Vector3.O);

        Vector3 vec1 = new Vector3(1.6, 0.6, 0.8);
    ...
    public void cylinderPhaseTest() {
        ...
        Assertions.assertEquals(0.8, cylinderPhase.intersectionPoint(vec2, vec3), 1e-12);
        Assertions.assertEquals(1, cylinderPhase.intersectionPoint(Vector3.O, vec3), 1e-12);
        Assertions.assertEquals(Double.POSITIVE_INFINITY, cylinderPhase.intersectionPoint(vec2, Vector3.X));
        Assertions.assertEquals(Double.POSITIVE_INFINITY, cylinderPhase.intersectionPoint(vec2, Vector3.Y));
    }
}
